...
GRANT Execute ON OBJECT::Entregas.SolicitudesDeEntregaListar  to [IIS APPPOOL\DefaultAppPool]
go
...
CREATE ROLE Publico 
GO 
GRANT EXECUTE ON UsuariosLogueo TO Publico
GO
...
GO
REVOKE EXECUTE ON UsuariosLogueo TO Empleado
GO
...
Alter Procedure UsuariosEmpresaAlta @NombreUsuario varchar(50), @Contrasenia varchar(6), @Nombre varchar(70), @Telefono varchar(9), @Direccion varchar(50), @Email varchar(50)  As
Begin
	Declare @VarSentencia varchar(200)
...
Begin
	 Select DISTINCT se.NumeroInterno as 'Numero Interno', se.FechaDeEntrega as 'Fecha de Entrega', se.NombreDestinatario as 'Nombre Destinatario', se.DireccionDestinatario as 'Direcciòn Destinatario', se.EstadoSolicitud as 'Estado' 
...
Begin
	...
	if (Not Exists (Select * From UsuariosEmpresa Where NombreUsuario = @NombreUsuarioEmpresa )) -- verificar si es activo todas las FK revisar que este activo
	Begin
		return -2
	End 
